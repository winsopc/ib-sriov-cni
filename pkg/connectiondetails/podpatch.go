...
const podAPITimeout = 10 * time.Second
...
func (c *PodClient) GetAnnotation(namespace, name string) (value, resourceVersion string, annotationsPresent bool, err error) {
	ctx, cancel := context.WithTimeout(context.Background(), podAPITimeout)
	defer cancel()
...
func (c *PodClient) PatchAnnotation(namespace, name, value, resourceVersion string, annotationsPresent bool) error {
