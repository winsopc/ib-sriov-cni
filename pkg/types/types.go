...
type IbSriovNetConf struct {
	...
	// PublishPfGUID publishes the connection-details
	// annotation, reading each PF node GUID via a temporary
	// vfio-pci->mlx5_core rebind.
	PublishPfGUID bool `json:"publishPfGuid,omitempty"`
	// Kubeconfig for pod annotation patching; defaults to the node-local
	// kubeconfig generated by the ib-sriov-cni DaemonSet entrypoint.
	Kubeconfig string `json:"kubeconfig,omitempty"`
	// LogFile appends connection-details debug lines (CNI stderr is hard to
	// reach); empty disables file logging.
